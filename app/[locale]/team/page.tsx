                ...
                <div className="grid grid-cols-1 sm:grid-cols-[220px_1fr]">
                  <div className="relative bg-green-800 flex items-center justify-center">
                    <div className="relative w-full h-64 sm:h-full min-h-[260px]">
                      <Image src={d.image} alt={d.name} fill className="object-contain" sizes="(max-width: 640px) 100vw, 220px" />
                    </div>
                  </div>
                  <div className="p-6 sm:p-8">
                    <h2 className="text-2xl font-bold text-gray-900 leading-tight">{d.name}</h2>
                    <span className="inline-block mt-1 mb-4 bg-green-100 text-green-800 text-xs font-semibold px-3 py-1 rounded-full">{d.title}</span>
