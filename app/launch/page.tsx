...
export default async function LaunchPage({ searchParams }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Top: Logo + name + tagline — compact, secondary */}
      <div className="flex flex-col items-center justify-center gap-4 px-8 pt-12 pb-8 relative z-10">
        ...
        <div className="animate-fade-up-delay text-center">
          <p
            className="text-white font-black tracking-[0.32em]"
            style={{ fontSize: "clamp(1.6rem, 5.5vw, 2.8rem)", textShadow: "0 2px 12px rgba(0,0,0,0.5)" }}
          >
            DHARE
          </p>
          <p
            className="text-green-300 font-bold tracking-[0.45em]"
        ...
        <div className="animate-fade-up-delay-2 flex flex-col items-center gap-3">
          ...
          <p
            className="text-green-200/70 text-center font-medium tracking-wide"
      ...
      {/* LAUNCH — dominant, takes the rest of the page */}
